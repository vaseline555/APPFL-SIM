...
# - MNIST non-IID: GPU 3
CASES=(
  "appfl_sim/config/sweeps/sw/cifar10_iid_swucb.yaml:0"
  "appfl_sim/config/sweeps/sw/cifar10_iid_swts.yaml:0"
  "appfl_sim/config/sweeps/sw/cifar10_non_iid_swucb.yaml:1"
  "appfl_sim/config/sweeps/sw/cifar10_non_iid_swts.yaml:1"
  "appfl_sim/config/sweeps/sw/mnist_iid_swucb.yaml:2"
  "appfl_sim/config/sweeps/sw/mnist_iid_swts.yaml:2"
  "appfl_sim/config/sweeps/sw/mnist_non_iid_swucb.yaml:3"
  "appfl_sim/config/sweeps/sw/mnist_non_iid_swts.yaml:3"
)
