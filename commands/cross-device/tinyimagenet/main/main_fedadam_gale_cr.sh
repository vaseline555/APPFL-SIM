...
#       "logging.configs.wandb_tags=cross-device,tinyimagenet,gale_adam_r,main" \
...
#       logging.name="main_tinyimagenet_gale_adam_r_${SEEDS[$i]}" &
# done
# wait

# Flattened commands
CUDA_VISIBLE_DEVICES= python -m appfl_sim.runner --config appfl_sim/config/cross-device/tinyimagenet/gale_adam_r.yaml logging.configs.wandb_entity=${WANDB_ENTITY} logging.configs.wandb_mode=${WANDB_MODE:-online} logging.configs.wandb_group=gale_adam_r logging.configs.wandb_tags=cross-device,tinyimagenet,gale_adam_r,main optimizer.lr_decay.enable=true optimizer.lr=0.001 optimizer.lr_decay.gamma=0.98 algorithm.scheduler_kwargs.discount_gamma=0.80 algorithm.scheduler_kwargs.exploration_beta=0.001 algorithm.scheduler_kwargs.ridge_alpha=1.0 algorithm.scheduler_kwargs.reward_scale=1 algorithm.scheduler_kwargs.contexts=[l,d] experiment.seed=1115802892 experiment.name=GALE_TINYIMAGENET logging.name=main_tinyimagenet_gale_adam_r_1115802892
CUDA_VISIBLE_DEVICES= python -m appfl_sim.runner --config appfl_sim/config/cross-device/tinyimagenet/gale_adam_r.yaml logging.configs.wandb_entity=${WANDB_ENTITY} logging.configs.wandb_mode=${WANDB_MODE:-online} logging.configs.wandb_group=gale_adam_r logging.configs.wandb_tags=cross-device,tinyimagenet,gale_adam_r,main optimizer.lr_decay.enable=true optimizer.lr=0.001 optimizer.lr_decay.gamma=0.98 algorithm.scheduler_kwargs.discount_gamma=0.80 algorithm.scheduler_kwargs.exploration_beta=0.001 algorithm.scheduler_kwargs.ridge_alpha=1.0 algorithm.scheduler_kwargs.reward_scale=1 algorithm.scheduler_kwargs.contexts=[l,d] experiment.seed=2998691888 experiment.name=GALE_TINYIMAGENET logging.name=main_tinyimagenet_gale_adam_r_2998691888
CUDA_VISIBLE_DEVICES= python -m appfl_sim.runner --config appfl_sim/config/cross-device/tinyimagenet/gale_adam_r.yaml logging.configs.wandb_entity=${WANDB_ENTITY} logging.configs.wandb_mode=${WANDB_MODE:-online} logging.configs.wandb_group=gale_adam_r logging.configs.wandb_tags=cross-device,tinyimagenet,gale_adam_r,main optimizer.lr_decay.enable=true optimizer.lr=0.001 optimizer.lr_decay.gamma=0.98 algorithm.scheduler_kwargs.discount_gamma=0.80 algorithm.scheduler_kwargs.exploration_beta=0.001 algorithm.scheduler_kwargs.ridge_alpha=1.0 algorithm.scheduler_kwargs.reward_scale=1 algorithm.scheduler_kwargs.contexts=[l,d] experiment.seed=1991082795 experiment.name=GALE_TINYIMAGENET logging.name=main_tinyimagenet_gale_adam_r_1991082795
