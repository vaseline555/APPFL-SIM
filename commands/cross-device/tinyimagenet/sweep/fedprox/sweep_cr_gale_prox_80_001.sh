...
#                         experiment.name=GALE_TINYIMAGENET_SWEEP logging.name="GALE_PROX_R_80_0.001_${lr_decay}_${contexts}_${ridge_alpha}" &
#     done
#   done
#   wait
# done
        ...
        algorithm.scheduler_kwargs.discount_gamma=0.80 \
          algorithm.scheduler_kwargs.exploration_beta=0.001 \
            ...
            algorithm.scheduler_kwargs.reward_scale=10 \
              "algorithm.scheduler_kwargs.contexts=[l,d]" \
                algorithm.trainer_kwargs.mu=0.3 \
                  experiment.name=GALE_TINYIMAGENET_SWEEP logging.name="GALE_PROX_R_80_0.001_0.995_[l,d]_10.0"
