...
# femnist contextual sweep for gale_avg_r
    ...
    for ridge_alpha in 0.1 1.0 10.0; do
      python -m appfl_sim.runner \
        --config appfl_sim/config/cross-device/femnist/gale_avg_r.yaml \
          ...
          "logging.configs.wandb_tags=cross-device,femnist,gale_avg_r,sweep" \
          ...
          logging.name="sweep_femnist_gale_avg_r_80_0.01_${lr_decay}_${context_tag}_${ridge_alpha}" &
    done
  done
  wait
done
