...
SWEEP_NAME="${SWEEP_NAME:-sweep_fedprox_gale_nc}"
RUN_CAP="${RUN_CAP:-60}"
GPU_IDS=(0 1 2 3)
...
cmd = [
    ...
    "appfl_sim.runner",
    "--config",
    "appfl_sim/config/cross-device/londonsmartmeter/gale_prox.yaml",
    ...
    "logging.configs.wandb_tags=cross-device,londonsmartmeter,gale_prox,sweep,bayes",
    "optimizer.lr=0.001",
    ...
    "logging.name="
    + f"sweep_fedprox_gale_nc_{args.discount_gamma:.2f}_{args.exploration_alpha:g}_{args.lr_decay_gamma:.2f}",
]
