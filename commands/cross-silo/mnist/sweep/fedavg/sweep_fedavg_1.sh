...
# Flattened commands
CUDA_VISIBLE_DEVICES=0 python -m appfl_sim.runner --config appfl_sim/config/cross-silo/mnist/fedavg.yaml logging.backend=file logging.configs.wandb_entity=${WANDB_ENTITY} logging.configs.wandb_mode=${WANDB_MODE:-online} logging.configs.wandb_group=fedavg logging.configs.wandb_tags=cross-silo,mnist,fedavg,sweep train.local_epochs=1 optimizer.lr_decay.enable=true optimizer.lr=0.1 optimizer.lr_decay.gamma=0.995 experiment.name=GALE_MNIST_SWEEP logging.name=sweep_mnist_fedavg_1_0.1
CUDA_VISIBLE_DEVICES=1 python -m appfl_sim.runner --config appfl_sim/config/cross-silo/mnist/fedavg.yaml logging.backend=file logging.configs.wandb_entity=${WANDB_ENTITY} logging.configs.wandb_mode=${WANDB_MODE:-online} logging.configs.wandb_group=fedavg logging.configs.wandb_tags=cross-silo,mnist,fedavg,sweep train.local_epochs=1 optimizer.lr_decay.enable=true optimizer.lr=0.01 optimizer.lr_decay.gamma=0.995 experiment.name=GALE_MNIST_SWEEP logging.name=sweep_mnist_fedavg_1_0.01
CUDA_VISIBLE_DEVICES=2 python -m appfl_sim.runner --config appfl_sim/config/cross-silo/mnist/fedavg.yaml logging.backend=file logging.configs.wandb_entity=${WANDB_ENTITY} logging.configs.wandb_mode=${WANDB_MODE:-online} logging.configs.wandb_group=fedavg logging.configs.wandb_tags=cross-silo,mnist,fedavg,sweep train.local_epochs=1 optimizer.lr_decay.enable=true optimizer.lr=0.0316 optimizer.lr_decay.gamma=0.995 experiment.name=GALE_MNIST_SWEEP logging.name=sweep_mnist_fedavg_1_0.0316
CUDA_VISIBLE_DEVICES=3 python -m appfl_sim.runner --config appfl_sim/config/cross-silo/mnist/fedavg.yaml logging.backend=file logging.configs.wandb_entity=${WANDB_ENTITY} logging.configs.wandb_mode=${WANDB_MODE:-online} logging.configs.wandb_group=fedavg logging.configs.wandb_tags=cross-silo,mnist,fedavg,sweep train.local_epochs=1 optimizer.lr_decay.enable=true optimizer.lr=0.316 optimizer.lr_decay.gamma=0.995 experiment.name=GALE_MNIST_SWEEP logging.name=sweep_mnist_fedavg_1_0.316
