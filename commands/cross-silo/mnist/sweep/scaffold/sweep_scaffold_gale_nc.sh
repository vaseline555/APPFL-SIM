...
cmd = [
    ...
    "appfl_sim.runner",
    "--config",
    "appfl_sim/config/cross-silo/mnist/gale_scaffold.yaml",
    ...
    "logging.configs.wandb_tags=cross-silo,mnist,gale_scaffold,sweep,bayes",
    ...
    "logging.name=" + f"sweep_mnist_gale_scaffold_{args.lr_decay_gamma:.2f}",
]
