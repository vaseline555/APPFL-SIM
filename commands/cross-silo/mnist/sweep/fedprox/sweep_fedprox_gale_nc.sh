...
WANDB_PROJECT="${WANDB_PROJECT:-GALE_MNIST_SWEEP}"
SWEEP_NAME="${SWEEP_NAME:-sweep_fedprox_gale_nc_bayes}"
RUN_CAP="${RUN_CAP:-5}"
GPU_IDS=(0 1 2 3)
...
launcher_program="${tmpdir}/sweep_fedprox_gale_nc_launcher.py"
...
wandb_project = os.environ.get("WANDB_PROJECT", "GALE_MNIST_SWEEP")
...
cmd = [
    ...
    "logging.name=" + f"sweep_mnist_gale_prox_{args.lr_decay_gamma:.2f}",
]

raise SystemExit(subprocess.call(cmd))
PY

sweep_config="${tmpdir}/sweep_fedprox_gale_nc.yaml"
