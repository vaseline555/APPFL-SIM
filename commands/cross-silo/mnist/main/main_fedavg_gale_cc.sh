...
# Flattened commands
CUDA_VISIBLE_DEVICES= python -m appfl_sim.runner --config appfl_sim/config/cross-silo/mnist/gale_avg_c.yaml logging.configs.wandb_entity=${WANDB_ENTITY} logging.configs.wandb_mode=${WANDB_MODE:-online} logging.configs.wandb_group=gale_avg_c logging.configs.wandb_tags=cross-silo,mnist,gale_avg_c,main optimizer.lr_decay.enable=true optimizer.lr=0.01 optimizer.lr_decay.gamma=0.98 algorithm.scheduler_kwargs.discount_gamma=0.80 algorithm.scheduler_kwargs.exploration_beta=0.01 algorithm.scheduler_kwargs.ridge_alpha=1.0 algorithm.scheduler_kwargs.reward_scale=1 algorithm.scheduler_kwargs.contexts=[l,d] experiment.seed=1115802892 experiment.name=GALE_MNIST logging.name=main_mnist_fedavg_gale_cc_1115802892
CUDA_VISIBLE_DEVICES= python -m appfl_sim.runner --config appfl_sim/config/cross-silo/mnist/gale_avg_c.yaml logging.configs.wandb_entity=${WANDB_ENTITY} logging.configs.wandb_mode=${WANDB_MODE:-online} logging.configs.wandb_group=gale_avg_c logging.configs.wandb_tags=cross-silo,mnist,gale_avg_c,main optimizer.lr_decay.enable=true optimizer.lr=0.01 optimizer.lr_decay.gamma=0.98 algorithm.scheduler_kwargs.discount_gamma=0.80 algorithm.scheduler_kwargs.exploration_beta=0.01 algorithm.scheduler_kwargs.ridge_alpha=1.0 algorithm.scheduler_kwargs.reward_scale=1 algorithm.scheduler_kwargs.contexts=[l,d] experiment.seed=2998691888 experiment.name=GALE_MNIST logging.name=main_mnist_fedavg_gale_cc_2998691888
CUDA_VISIBLE_DEVICES= python -m appfl_sim.runner --config appfl_sim/config/cross-silo/mnist/gale_avg_c.yaml logging.configs.wandb_entity=${WANDB_ENTITY} logging.configs.wandb_mode=${WANDB_MODE:-online} logging.configs.wandb_group=gale_avg_c logging.configs.wandb_tags=cross-silo,mnist,gale_avg_c,main optimizer.lr_decay.enable=true optimizer.lr=0.01 optimizer.lr_decay.gamma=0.98 algorithm.scheduler_kwargs.discount_gamma=0.80 algorithm.scheduler_kwargs.exploration_beta=0.01 algorithm.scheduler_kwargs.ridge_alpha=1.0 algorithm.scheduler_kwargs.reward_scale=1 algorithm.scheduler_kwargs.contexts=[l,d] experiment.seed=1991082795 experiment.name=GALE_MNIST logging.name=main_mnist_fedavg_gale_cc_1991082795
