...
#                 experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_gale_scaffold_${lr_decay}" &
# done
# wait
    ...
    logging.configs.wandb_entity=vaseline555 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.93 \
        algorithm.scheduler_kwargs.discount_gamma=0.80 \
          algorithm.scheduler_kwargs.exploration_alpha=0.0005 \
            algorithm.scheduler_kwargs.reward_scale=1 \
              experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_gale_scaffold_0.93"
    ...
    logging.configs.wandb_entity=vaseline555 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.95 \
        algorithm.scheduler_kwargs.discount_gamma=0.80 \
          algorithm.scheduler_kwargs.exploration_alpha=0.0005 \
            algorithm.scheduler_kwargs.reward_scale=1 \
              experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_gale_scaffold_0.95"
    ...
    logging.configs.wandb_entity=vaseline555 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.97 \
        algorithm.scheduler_kwargs.discount_gamma=0.80 \
          algorithm.scheduler_kwargs.exploration_alpha=0.0005 \
            algorithm.scheduler_kwargs.reward_scale=1 \
              experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_gale_scaffold_0.97"
    ...
    logging.configs.wandb_entity=vaseline555 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.99 \
        algorithm.scheduler_kwargs.discount_gamma=0.80 \
          algorithm.scheduler_kwargs.exploration_alpha=0.0005 \
            algorithm.scheduler_kwargs.reward_scale=1 \
              experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_gale_scaffold_0.99"
