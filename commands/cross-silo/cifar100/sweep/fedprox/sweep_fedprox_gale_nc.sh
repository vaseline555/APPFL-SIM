...
cmd = [
    ...
    "appfl_sim.runner",
    "--config",
    "appfl_sim/config/cross-silo/cifar100/gale_prox.yaml",
    ...
    "logging.configs.wandb_tags=cross-silo,cifar100,gale_prox,sweep,bayes",
    "optimizer.lr=0.001",
    ...
    "logging.name=" + f"sweep_fedprox_gale_nc_{args.discount_gamma:.2f}_{args.exploration_alpha:g}_{args.lr_decay_gamma:.2f}",
]
