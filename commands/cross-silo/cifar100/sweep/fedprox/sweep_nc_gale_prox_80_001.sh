...
#                   experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_gale_prox_80_0.001_${lr_decay}" &
# done
# wait
      ...
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.95 \
        algorithm.scheduler_kwargs.discount_gamma=0.80 \
          algorithm.scheduler_kwargs.exploration_alpha=0.001 \
            algorithm.scheduler_kwargs.reward_scale=1 \
              algorithm.trainer_kwargs.mu=0.3 \
                experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_gale_prox_80_0.001_0.95"
      ...
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.96 \
        algorithm.scheduler_kwargs.discount_gamma=0.80 \
          algorithm.scheduler_kwargs.exploration_alpha=0.001 \
            algorithm.scheduler_kwargs.reward_scale=1 \
              algorithm.trainer_kwargs.mu=0.3 \
                experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_gale_prox_80_0.001_0.96"
      ...
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.97 \
        algorithm.scheduler_kwargs.discount_gamma=0.80 \
          algorithm.scheduler_kwargs.exploration_alpha=0.001 \
            algorithm.scheduler_kwargs.reward_scale=1 \
              algorithm.trainer_kwargs.mu=0.3 \
                experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_gale_prox_80_0.001_0.97"
      ...
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.98 \
        algorithm.scheduler_kwargs.discount_gamma=0.80 \
          algorithm.scheduler_kwargs.exploration_alpha=0.001 \
            algorithm.scheduler_kwargs.reward_scale=1 \
              algorithm.trainer_kwargs.mu=0.3 \
                experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_gale_prox_80_0.001_0.98"
      ...
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.99 \
        algorithm.scheduler_kwargs.discount_gamma=0.80 \
          algorithm.scheduler_kwargs.exploration_alpha=0.001 \
            algorithm.scheduler_kwargs.reward_scale=1 \
              algorithm.trainer_kwargs.mu=0.3 \
                experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_gale_prox_80_0.001_0.99"
