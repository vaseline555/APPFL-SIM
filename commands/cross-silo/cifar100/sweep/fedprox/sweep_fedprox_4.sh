...
#               experiment.name=GALE_CIFAR100_SWEEP logging.name="fedprox_4_${mu}" &
# done
# wait
    ...
    logging.configs.wandb_entity=vaseline555 train.local_epochs=4 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.96 \
        algorithm.trainer_kwargs.mu=0.05 \
          experiment.name=GALE_CIFAR100_SWEEP logging.name="fedprox_4_0.05"
    ...
    logging.configs.wandb_entity=vaseline555 train.local_epochs=4 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.96 \
        algorithm.trainer_kwargs.mu=0.07 \
          experiment.name=GALE_CIFAR100_SWEEP logging.name="fedprox_4_0.07"
    ...
    logging.configs.wandb_entity=vaseline555 train.local_epochs=4 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.96 \
        algorithm.trainer_kwargs.mu=0.1 \
          experiment.name=GALE_CIFAR100_SWEEP logging.name="fedprox_4_0.1"
    ...
    logging.configs.wandb_entity=vaseline555 train.local_epochs=4 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.96 \
        algorithm.trainer_kwargs.mu=0.2 \
          experiment.name=GALE_CIFAR100_SWEEP logging.name="fedprox_4_0.2"
    ...
    logging.configs.wandb_entity=vaseline555 train.local_epochs=4 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.96 \
        algorithm.trainer_kwargs.mu=0.3 \
          experiment.name=GALE_CIFAR100_SWEEP logging.name="fedprox_4_0.3"
