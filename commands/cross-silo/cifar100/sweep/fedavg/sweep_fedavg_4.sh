  ...
  --config appfl_sim/config/cross-silo/cifar100/fedavg.yaml \
    logging.configs.wandb_entity=vaseline555 train.local_epochs=4 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.98 \
        experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_fedavg_4_0.98"

python -m appfl_sim.runner \
  --config appfl_sim/config/cross-silo/cifar100/fedavg.yaml \
    logging.configs.wandb_entity=vaseline555 train.local_epochs=4 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.97 \
        experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_fedavg_4_0.97"

python -m appfl_sim.runner \
  --config appfl_sim/config/cross-silo/cifar100/fedavg.yaml \
    logging.configs.wandb_entity=vaseline555 train.local_epochs=4 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.96 \
        experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_fedavg_4_0.96"

python -m appfl_sim.runner \
  --config appfl_sim/config/cross-silo/cifar100/fedavg.yaml \
    logging.configs.wandb_entity=vaseline555 train.local_epochs=4 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.95 \
        experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_fedavg_4_0.95"
