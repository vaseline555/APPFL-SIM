...
#                 experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_gale_avg_80_0.001_${lr_decay}" &
# done
# wait
    ...
    logging.configs.wandb_entity=vaseline555 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.98 \
        algorithm.scheduler_kwargs.discount_gamma=0.80 \
          algorithm.scheduler_kwargs.exploration_alpha=0.001 \
            algorithm.scheduler_kwargs.reward_scale=10 \
              experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_gale_avg_80_0.001_0.98"
    ...
    logging.configs.wandb_entity=vaseline555 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.99 \
        algorithm.scheduler_kwargs.discount_gamma=0.80 \
          algorithm.scheduler_kwargs.exploration_alpha=0.001 \
            algorithm.scheduler_kwargs.reward_scale=10 \
              experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_gale_avg_80_0.001_0.99"
    ...
    logging.configs.wandb_entity=vaseline555 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.995 \
        algorithm.scheduler_kwargs.discount_gamma=0.80 \
          algorithm.scheduler_kwargs.exploration_alpha=0.001 \
            algorithm.scheduler_kwargs.reward_scale=10 \
              experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_gale_avg_80_0.001_0.995"
