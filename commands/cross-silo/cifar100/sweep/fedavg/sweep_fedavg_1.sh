  ...
  --config appfl_sim/config/cross-silo/cifar100/fedavg.yaml \
    logging.configs.wandb_entity=vaseline555 train.local_epochs=1 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.999 \
        experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_fedavg_1_0.999"

python -m appfl_sim.runner \
  --config appfl_sim/config/cross-silo/cifar100/fedavg.yaml \
    logging.configs.wandb_entity=vaseline555 train.local_epochs=1 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.995 \
        experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_fedavg_1_0.995"

python -m appfl_sim.runner \
  --config appfl_sim/config/cross-silo/cifar100/fedavg.yaml \
    logging.configs.wandb_entity=vaseline555 train.local_epochs=1 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.99 \
        experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_fedavg_1_0.99"

python -m appfl_sim.runner \
  --config appfl_sim/config/cross-silo/cifar100/fedavg.yaml \
    logging.configs.wandb_entity=vaseline555 train.local_epochs=1 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.985 \
        experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_fedavg_1_0.985"
