  ...
  --config appfl_sim/config/cross-silo/cifar100/fedavg.yaml \
    logging.configs.wandb_entity=vaseline555 train.local_epochs=8 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.965 \
        experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_fedavg_8_0.965"

python -m appfl_sim.runner \
  --config appfl_sim/config/cross-silo/cifar100/fedavg.yaml \
    logging.configs.wandb_entity=vaseline555 train.local_epochs=8 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.96 \
        experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_fedavg_8_0.96"

python -m appfl_sim.runner \
  --config appfl_sim/config/cross-silo/cifar100/fedavg.yaml \
    logging.configs.wandb_entity=vaseline555 train.local_epochs=8 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.955 \
        experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_fedavg_8_0.955"

python -m appfl_sim.runner \
  --config appfl_sim/config/cross-silo/cifar100/fedavg.yaml \
    logging.configs.wandb_entity=vaseline555 train.local_epochs=8 \
      optimizer.lr=0.001 optimizer.lr_decay.gamma=0.95 \
        experiment.name=GALE_CIFAR100_SWEEP logging.name="sweep_fedavg_8_0.95"
