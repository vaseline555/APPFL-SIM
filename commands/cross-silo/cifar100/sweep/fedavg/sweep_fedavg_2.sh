...
# Flattened commands
CUDA_VISIBLE_DEVICES= python -m appfl_sim.runner --config appfl_sim/config/cross-silo/cifar100/fedavg.yaml logging.backend=file logging.configs.wandb_entity=vaseline555 train.local_epochs=2 optimizer.lr=0.001 optimizer.lr_decay.gamma=0.995 experiment.name=GALE_CIFAR100_SWEEP logging.name=sweep_fedavg_2_0.995
CUDA_VISIBLE_DEVICES= python -m appfl_sim.runner --config appfl_sim/config/cross-silo/cifar100/fedavg.yaml logging.backend=file logging.configs.wandb_entity=vaseline555 train.local_epochs=2 optimizer.lr=0.001 optimizer.lr_decay.gamma=0.99 experiment.name=GALE_CIFAR100_SWEEP logging.name=sweep_fedavg_2_0.99
