...
# 20newsgroups sweep for gale_scaffold_c
  ...
  for ridge_alpha in 0.1 1.0 10.0; do
    python -m appfl_sim.runner \
      --config appfl_sim/config/cross-silo/20newsgroups/gale_scaffold_c.yaml \
        ...
        "logging.configs.wandb_tags=cross-silo,20newsgroups,gale_scaffold_c,sweep" \
        ...
        logging.name="sweep_20newsgroups_gale_scaffold_c_${lr_decay}_${ridge_alpha}" &
  done
  wait
done
