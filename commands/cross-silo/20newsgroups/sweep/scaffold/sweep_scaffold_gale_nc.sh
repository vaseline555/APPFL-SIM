...
WANDB_PROJECT="${WANDB_PROJECT:-GALE_20NEWSGROUPS_SWEEP}"
...
launcher_program="${tmpdir}/sweep_scaffold_gale_nc_launcher.py"
...
wandb_project = os.environ.get("WANDB_PROJECT", "GALE_20NEWSGROUPS_SWEEP")
...
cmd = [
    ...
    "appfl_sim.runner",
    "--config",
    "appfl_sim/config/cross-silo/20newsgroups/gale_scaffold.yaml",
...
f"logging.configs.wandb_entity={wandb_entity}",
    ...
    "logging.configs.wandb_tags=cross-silo,20newsgroups,gale_scaffold,sweep,bayes",
    ...
    "logging.name=" + f"sweep_20newsgroups_gale_scaffold_{args.lr_decay_gamma:.2f}",
]

raise SystemExit(subprocess.call(cmd))
PY

sweep_config="${tmpdir}/sweep_scaffold_gale_nc.yaml"
