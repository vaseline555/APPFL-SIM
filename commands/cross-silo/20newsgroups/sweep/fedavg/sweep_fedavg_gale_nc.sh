...
cmd = [
    ...
    "appfl_sim.runner",
    "--config",
    "appfl_sim/config/cross-silo/20newsgroups/gale_avg.yaml",
...
f"logging.configs.wandb_entity={wandb_entity}",
    ...
    "logging.configs.wandb_tags=cross-silo,20newsgroups,gale_avg,sweep,bayes",
    ...
    "logging.name=" + f"sweep_20newsgroups_gale_avg_{args.lr_decay_gamma:.2f}",
]
