...
#     --config appfl_sim/config/cross-silo/20newsgroups/gale_avg_c.yaml \
#       "logging.configs.wandb_entity=${WANDB_ENTITY}" \
#       "logging.configs.wandb_mode=${WANDB_MODE}" \
#       logging.configs.wandb_group=gale_avg_c \
#       "logging.configs.wandb_tags=cross-silo,20newsgroups,gale_avg_c,main" \
