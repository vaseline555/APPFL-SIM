    ...
    def _attach_local_gen_error(
        ...
        *,
        ...
        if (
            ...
            and isinstance(result.get("pre_val_loss"), (int, float))
            and isinstance(result.get("pre_train_loss"), (int, float))
        ):
            result["local_gen_error"] = float(
                float(result["pre_val_loss"]) - float(result["pre_train_loss"])
            )
        return result
